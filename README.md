...
| **responsive** | 667 `_t`/`_m` declarations across two sites asserted against the stylesheet the site actually served — all verified |
...
| **browser** | 3,274 computed-style readings on the delivered page in Chromium at three viewports: 2,551 compared and agreed, 723 not-comparable and labelled, **0 overridden** |
